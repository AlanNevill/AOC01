        ...
        static void Main(string[] args)
        {
            ...
            foreach (var year in years)
            {
                foreach (var year2 in years)
                {
                    if (year + year2 == 2020)
                    {
                        Console.WriteLine($"{year} {year2}");
                    }
                }
            }

            watch.Stop();
            Log($"INFO\t- Completed in {watch.ElapsedMilliseconds} milliseconds.");
        }
